import{p as k,d as E,g as Ze,s as Qe,h as Ye,u as ke,i as R,m as Xe,j as ye,f as _e,k as Ce,l as et,n as tt,o as nt,q as rt,a as at,r as st}from"./theme-CzeyRWKH.js";function I(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ot(e){return e==="bookings"?`
  ...
  `}function it(e){const t=String((e==null?void 0:e.domain)??"").trim();if(!t)return{href:"https://autoservicehouse.nl",label:"autoservicehouse.nl"};const n=/^https?:\/\//i.test(t)?t:`https://${t}`,r=t.replace(/^https?:\/\//i,"");return{href:n,label:r}}function ct(e){const n={dashboard:"dashboard",calendar:"calender",analytics:"analytics",bookings:"appointment",addappointment:"addappointment",emails:"email",completed:"succes",werkbon:"werkbon"}[e];return n?E(`sidebar-icons/${n}.png`):null}function lt({title:e,headerNote:t="",garage:n,activePage:r="dashboard"}){var c;const a=document.createElement("div");a.className="topbar-stack";const i=it(n),o=I(e);I(t);const l=I(i.label);I(i.href);const h=I(String(((c=n==null?void 0:n.name)==null?void 0:c[0])??"G").toUpperCase()),d=n!=null&&n.logoUrl?`<img class="brand-logo" src="${I(n.logoUrl)}" alt="" />`:`<span class="brand-mark">${h}</span>`,y=I((n==null?void 0:n.name)??""),b=ct(r),s=b?`<img class="topbar-page-icon topbar-page-icon-${I(r)}" src="${b}" alt="${o} icon" />`:`<span class="topbar-page-icon topbar-page-icon-${I(r)}">${ot(r)}</span>`;a.innerHTML=`
    <header class="topbar">
  ...
  `;const m=a.querySelector(".topbar"),g=a.querySelector(".topbar-title-row");return{header:m,titleRow:g}}const dt=[{key:"dashboard",href:k("dashboard.html"),label:"Dashboard",icon:"dashboard"},{key:"calendar",href:k("calendar.html"),label:"Calendar",icon:"calendar"},{key:"bookings",href:k("bookings.html"),label:"Appointment",icon:"appointments"},{key:"completed",href:k("completed.html"),label:"Completed",icon:"completed"},{key:"werkbon",href:k("werkbon.html"),label:"Werkbon",icon:"werkbon"},{key:"addappointment",href:k("add-appointment.html"),label:"Add Appointment",icon:"addappointment"},{key:"emails",href:k("emails.html"),label:"E-mails",icon:"emails",showUnreadBadge:!0},{key:"analytics",href:k("analytics.html"),label:"Analytics",icon:"analytics"},{key:"settings",href:k("settings.html"),label:"Instellingen",icon:"settings"}],pe={dashboard:E("sidebar-icons/dashboard.png"),appointments:E("sidebar-icons/appointment.png"),calendar:E("sidebar-icons/calender.png"),completed:E("sidebar-icons/succes.png"),werkbon:E("sidebar-icons/werkbon.png"),addappointment:E("sidebar-icons/addappointment.png"),emails:E("sidebar-icons/email.png"),analytics:E("sidebar-icons/analytics.png"),default:E("sidebar-icons/default.png"),settings:E("sidebar-icons/default.png")},me="garage-dashboard.sidebar-collapsed";function ut(e){return`<img class="sidebar-link-icon-image" src="${pe[e]??pe.default}" alt="" width="32" height="33" aria-hidden="true" />`}function pt(e){return e?((String(e).split("@")[0]??"A")[0]??"A").toUpperCase():"A"}function mt(e,t){if(t)return t;const n=String(e??"").trim().split("@")[0];return n?n.split(/[._-]+/g).filter(Boolean).map(r=>r[0].toUpperCase()+r.slice(1)).slice(0,2).join(" "):"Garage User"}function ht(e){var t;return e!=null&&e.logoUrl?`<img class="brand-logo" src="${e.logoUrl}" alt="${e.name} logo" />`:`<span class="brand-mark">${String(((t=e==null?void 0:e.name)==null?void 0:t[0])??"A").toUpperCase()}</span>`}function Ae(e,t){const n=Number(t),r=Number.isFinite(n)?Math.max(0,Math.floor(n)):0;e.querySelectorAll("[data-email-unread-count]").forEach(i=>{i.textContent=r>99?"99+":String(r),i.hidden=r===0})}function ft(e,{garage:t,isAdmin:n=!1,userEmail:r="",onLogout:a,unreadEmailCount:i=0}={}){const o=document.createElement("aside");o.className="sidebar";const l=window.localStorage.getItem(me)==="true";l&&(o.classList.add("is-collapsed"),o.dataset.collapsed="true");const h=dt.map(v=>{const p=v.key===e?"is-active":"";return`
      <a class="sidebar-link sidebar-link-${v.key} ${p}" href="${v.href}">
        <span class="sidebar-link-icon">${ut(v.icon)}</span>
    ...
    `}).join(""),d=mt(r,n?"Admin":""),y=n?"Owner":(t==null?void 0:t.name)??"Garage Staff",b=Ze()==="dark",s=l?"Expand sidebar":"Collapse sidebar";o.innerHTML=`
    ...
    <div class="sidebar-footer">
      ...
      <div class="sidebar-user-card">
        <span class="sidebar-avatar">${pt(r)}</span>
...
${Q}`;if(!l)throw new Error("A garage is required before creating a manual appointment.");if(!d||!y||!b||!s||!o)throw new Error("Please fill in kenteken, phone number, service, bericht, and appointment date.");const g=new Date().toISOString(),c=vt(o,g),C=await nt({garageId:l,name:h,licensePlate:d,phone:y,service:b,message:m,createdAt:g});if(C){try{await ke({bookingId:C.id,garageId:l,appointmentAt:c})}catch(S){console.warn("Unable to persist booking schedule in Supabase booking_schedule.",S)}return N(C.id,{convertedFromEmail:!1,inAppointments:!0,status:"new",appointmentAt:c}),V({...C,appointment_at:c,source:"manual",status:"new"})}const v={id:St(),garage_id:l,name:h,license_plate:d,phone:y,service:b,message:m,appointment_at:c,status:"new",source:"manual",created_at:g},p=te();return p.unshift(v),Ie(p.slice(0,500)),N(v.id,{convertedFromEmail:!1,inAppointments:!0,status:"new",appointmentAt:c}),V(v)}async function $t({garageIds:e=null}={}){const t=await Ye({garageIds:e}),n=At({garageIds:e}),r=ee(),a=[...t.map(V),...n],i=new Map;for(const o of a){const l=String(o.id??"").trim();l&&(i.has(l)||i.set(l,o))}return Array.from(i.values()).map(o=>wt(o,r)).filter(o=>o.isDeleted!==!0).sort(Et)}const Pe="garage_dashboard_email_read_state_v1";function De(){return typeof window<"u"&&typeof window.localStorage<"u"}function He(){if(!De())return{};try{const e=window.localStorage.getItem(Pe);if(!e)return{};const t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Mt(e){De()&&window.localStorage.setItem(Pe,JSON.stringify(e))}function ne(e){return String(e??"").trim()}function F(e,t){var r;const n=new RegExp(`\\b${t}\\s*:\\s*([\\s\\S]*?)(?=\\b(?:name|email|message|description|source|submittedat)\\s*:|$)`,"i");return(((r=e.match(n))==null?void 0:r[1])??"").trim()}function Nt(e){const t=String(e??"").trim();return t?/\b(?:name|email|message)\s*:/i.test(t)?{name:F(t,"name"),email:F(t,"email"),message:F(t,"message")||F(t,"description")}:{name:"",email:"",message:t}:{name:"",email:"",message:""}}function he(e){const n=new Date(e).getTime();return Number.isFinite(n)?n:0}function It(e){const t=String(e??"new").trim().toLowerCase();return t==="done"||t==="completed"||t==="complete"||t==="closed"?"done":t==="confirmed"||t==="confirm"?"confirmed":"new"}function Be(e){return String((e==null?void 0:e.source)??"form")==="manual"||(e==null?void 0:e.hasScheduledAppointment)===!0||(e==null?void 0:e.convertedFromEmail)===!0?!1:It(e==null?void 0:e.status)!=="done"}function Ue(e){const t=ne(e);return t?He()[t]===!0:!1}function Sn(e,t=!0){const n=ne(e);if(!n)return;const r=He();t?r[n]=!0:delete r[n],Mt(r)}function kn(e){const t=e.filter(Be);let n=0;for(const r of t)Ue(r.id)||(n+=1);return{total:t.length,unread:n}}function xt(e,{garageNameById:t=new Map}={}){return e.filter(Be).map(n=>{const r=Nt(n.message),a=ne(n.id),i=`${n.licensePlate??"Unknown"} • ${n.service??"Service request"}`,o=r.message||String(n.message??"").trim()||"No message provided.",l=String(n.name??"").trim()||r.name||String(n.licensePlate??"").trim()||"UNKNOWN",h=r.email||"";return{id:a,subject:i,preview:o,message:o,senderName:l,senderEmail:h,phone:n.phone??"",service:n.service??"",licensePlate:n.licensePlate??"",garageId:n.garageId,garageName:t.get(n.garageId)??"",receivedAt:n.createdAt,appointmentAt:n.appointmentAt??n.createdAt,read:Ue(a)}}).sort((n,r)=>he(r.receivedAt)-he(n.receivedAt))}const fe=2,Tt=300,Rt=3e4,Pt=6e4,re=80,je="garage-dashboard.recent-searches",Fe=5,G=new Map,q=new Map;function _(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Dt(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function $(e,t){const n=_(e??""),r=String(t??"").trim().slice(0,re);if(!r)return n;const a=new RegExp(`(${Dt(r)})`,"ig");return n.replace(a,"<mark>$1</mark>")}function U(e){const t=String(e??"").toUpperCase().replace(/[^A-Z0-9]/g,"");return t?t.replace(/(.{2})(?=.)/g,"$1-"):""}function z(e){const t=new Date(e);return Number.isNaN(t.getTime())?"-":t.toLocaleDateString("nl-NL",{day:"2-digit",month:"short",year:"numeric"})}function ge(e){const t=Number(e??0);return Number.isFinite(t)?new Intl.NumberFormat("nl-NL",{style:"currency",currency:"EUR",minimumFractionDigits:2,maximumFractionDigits:2}).format(t):"EUR 0,00"}function ae(e){const t=String(e??"").trim().toLowerCase();return["done","completed","complete","closed"].includes(t)?"completed":["confirmed","confirm"].includes(t)?"confirmed":t||"new"}function Ht(e){const t=ae(e);return t==="completed"?"Voltooid":t==="confirmed"?"Bevestigd":t==="new"?"Nieuw":t}function we(e){const t=String(e??"").replace(/[^a-z0-9]/gi,"");return t.length>=4&&/[a-z]/i.test(t)&&/\d/.test(t)}function be(e){return/\d/.test(String(e??""))}function M(e){return{calendar:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M6 2.75V5M14 2.75V5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><rect x="3" y="4.5" width="14" height="12.5" rx="3" stroke="currentColor" stroke-width="1.6"/><path d="M3 8.5H17" stroke="currentColor" stroke-width="1.6"/></svg>',fileText:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M6.5 2.5H11.5L15.5 6.5V15.5C15.5 16.33 14.83 17 14 17H6C5.17 17 4.5 16.33 4.5 15.5V4C4.5 3.17 5.17 2.5 6 2.5H6.5Z" stroke="currentColor" stroke-width="1.6"/><path d="M11.5 2.5V6.5H15.5" stroke="currentColor" stroke-width="1.6"/><path d="M7 10H13M7 13H11" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',check:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="7.5" stroke="currentColor" stroke-width="1.6"/><path d="M6.8 10.2L8.9 12.3L13.3 7.9" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>',user:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="6.5" r="3" stroke="currentColor" stroke-width="1.6"/><path d="M4 16.2C4.8 13.9 6.8 12.8 10 12.8C13.2 12.8 15.2 13.9 16 16.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',mail:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><rect x="3" y="4.5" width="14" height="11" rx="2.5" stroke="currentColor" stroke-width="1.6"/><path d="M4.5 6L10 10L15.5 6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',car:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M4 11.5L5.5 7.5C5.8 6.8 6.4 6.4 7.2 6.4H12.8C13.6 6.4 14.2 6.8 14.5 7.5L16 11.5" stroke="currentColor" stroke-width="1.6"/><rect x="3.2" y="10" width="13.6" height="5.5" rx="1.8" stroke="currentColor" stroke-width="1.6"/><circle cx="6.5" cy="14" r="1.1" fill="currentColor"/><circle cx="13.5" cy="14" r="1.1" fill="currentColor"/></svg>',receipt:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M6 2.8H14V16.8L12 15.5L10 16.8L8 15.5L6 16.8V2.8Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M8 6.8H12M8 9.8H12M8 12.8H11" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',plus:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="7.5" stroke="currentColor" stroke-width="1.6"/><path d="M10 6.5V13.5M6.5 10H13.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',settings:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M10 6.9A3.1 3.1 0 1 1 10 13.1A3.1 3.1 0 0 1 10 6.9Z" stroke="currentColor" stroke-width="1.6"/><path d="M16.1 10.9L15 11.4C14.9 11.8 14.7 12.2 14.5 12.5L14.9 13.7L13.7 14.9L12.5 14.5C12.2 14.7 11.8 14.9 11.4 15L10.9 16.1H9.1L8.6 15C8.2 14.9 7.8 14.7 7.5 14.5L6.3 14.9L5.1 13.7L5.5 12.5C5.3 12.2 5.1 11.8 5 11.4L3.9 10.9V9.1L5 8.6C5.1 8.2 5.3 7.8 5.5 7.5L5.1 6.3L6.3 5.1L7.5 5.5C7.8 5.3 8.2 5.1 8.6 5L9.1 3.9H10.9L11.4 5C11.8 5.1 12.2 5.3 12.5 5.5L13.7 5.1L14.9 6.3L14.5 7.5C14.7 7.8 14.9 8.2 15 8.6L16.1 9.1V10.9Z" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"/></svg>',clock:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="7.5" stroke="currentColor" stroke-width="1.6"/><path d="M10 6.4V10L12.5 11.4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',searchX:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="8.5" cy="8.5" r="5.8" stroke="currentColor" stroke-width="1.6"/><path d="M12.7 12.7L17 17" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M6.8 6.8L10.2 10.2M10.2 6.8L6.8 10.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',arrowLeft:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M11.8 4.8L6.6 10L11.8 15.2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>'}[e]??""}function se(){try{const e=JSON.parse(window.localStorage.getItem(je)||"[]");return Array.isArray(e)?e.map(t=>String(t??"").trim()).filter(Boolean).slice(0,Fe):[]}catch{return[]}}function X(e){try{window.localStorage.setItem(je,JSON.stringify(e.slice(0,Fe)))}catch{}}function Bt(e){const t=String(e??"").trim();if(!t)return;const n=se().filter(r=>r.toLowerCase()!==t.toLowerCase());n.unshift(t),X(n)}function K(e){const t=ae(e);return t==="completed"?'<span class="global-search-badge global-search-badge-success">Voltooid</span>':t==="confirmed"?'<span class="global-search-badge global-search-badge-info">Bevestigd</span>':t==="new"?'<span class="global-search-badge global-search-badge-muted">Nieuw</span>':`<span class="global-search-badge global-search-badge-muted">${_(Ht(t))}</span>`}function Ut(){return/Mac|iPhone|iPad|iPod/i.test(window.navigator.platform)?"⌘K":"Ctrl+K"}function Ge(e,t){var a;const n=String(e??""),r=new RegExp(`\\b${t}\\s*:\\s*([\\s\\S]*?)(?=\\b(?:name|email|message)\\s*:|$)`,"i");return(((a=n.match(r))==null?void 0:a[1])??"").trim()}function W(e){return String(e??"").toLowerCase().replace(/[^a-z0-9]/g,"")}function jt(e){return String(e??"").trim().slice(0,re)}function Ft(e){const t=String((e==null?void 0:e.name)??"").trim();if(t)return t;const n=Ge(e==null?void 0:e.message,"name");return n||String((e==null?void 0:e.licensePlate)??"").trim()||"UNKNOWN"}function Gt(e){return Ge(e==null?void 0:e.message,"email")}function qt(e,t,n,r){const a=e.filter(s=>ae(s==null?void 0:s.status)!=="completed"&&(s==null?void 0:s.inAppointments)!==!1).map(s=>({id:s.id,customer_name:Ft(s),customer_email:Gt(s),customer_phone:String(s.phone??""),license_plate:String(s.licensePlate??""),car_brand:String(s.service??"Service"),status:s.status,appointment_date:s.appointmentAt||s.createdAt,services:s.service})),i=t.map(s=>({id:s.id,customer_name:s.customerName||"Onbekende klant",license_plate:s.licensePlate,car_brand:s.service||"Service",appointment_date:s.appointmentAt||s.completedAt||s.createdAt,status:"completed"})),o=[...a,...i],l=new Map;a.forEach(s=>{const m=`${s.customer_name}|${s.customer_email}|${s.license_plate}`.toLowerCase();l.has(m)||l.set(m,{customer_name:s.customer_name,customer_email:s.customer_email,customer_phone:s.customer_phone,license_plate:s.license_plate,car_brand:s.car_brand})});const h=new Map;n.forEach(s=>{let m={};try{m=JSON.parse(String(s.completion_notes??"{}"))}catch{m={}}h.set(String(s.id??""),m)});const d=t.map(s=>{var c;const m=h.get(String(s.completedAppointmentId??""))??{},g=Number(((c=m==null?void 0:m.totals)==null?void 0:c.total)??0);return{id:s.completedAppointmentId,customer_name:s.customerName||String(m.customer_name??"Onbekende klant"),license_plate:s.licensePlate,car_brand:String(m.car_model??s.service??"Service"),total:g,status:String(m.status??"draft"),factuurnummer:String(m.invoice_number??"").trim(),created_at:s.createdAt}}),y=d.filter(s=>s.factuurnummer),b=r.map(s=>({id:s.id,from_name:s.senderName,from_email:s.senderEmail,subject:s.subject,created_at:s.receivedAt,read:s.read}));return{appointmentsSource:a,completedSource:i,plateSource:o,customerSource:Array.from(l.values()),werkbonSource:d,invoiceSource:y,emailsSource:b}}function zt(e){const t=(d,y)=>d.map(b=>({...b,_searchToken:W(y.map(s=>String(b[s]??"")).join(" "))})),n=t(e.appointmentsSource,["customer_name","customer_email","customer_phone","license_plate","car_brand"]),r=t(e.completedSource,["customer_name","license_plate","car_brand"]),a=t(e.customerSource,["customer_name","customer_email","customer_phone","license_plate","car_brand"]),i=t(e.werkbonSource,["customer_name","license_plate","car_brand","factuurnummer"]),o=t(e.emailsSource,["from_name","from_email","subject"]),l=[...n,...r].map(d=>({...d,_plateToken:W(d.license_plate)})),h=e.invoiceSource.map(d=>({...d,_invoiceToken:W(d.factuurnummer)}));return{appointments:n,completed:r,customers:a,werkbonnen:i,emails:o,plates:l,invoices:h}}function D(e,t,n,r){const a=[];for(const i of e)if(r(i,t)&&(a.push(i),a.length>=n))break;return a}async function Kt(e){const t=String(e??"").trim(),n=Date.now(),r=q.get(t);if(r!=null&&r.data&&n-r.timestamp<Pt)return r.data;if(r!=null&&r.inFlight)return r.inFlight;const a=Promise.all([$t({garageIds:[t]}),Lt({garageIds:[t]}),_e({garageIds:[t]})]).then(([i,o,l])=>{const h=xt(i),d=qt(i,o,l,h);return{indexed:zt(d)}});q.set(t,{timestamp:n,data:(r==null?void 0:r.data)??null,inFlight:a});try{const i=await a;return q.set(t,{timestamp:Date.now(),data:i,inFlight:null}),i}catch(i){if(r!=null&&r.data)return r.data;throw q.delete(t),i}}function ve(e){const t=String(e??"").trim().toLowerCase(),n=[{key:"new-appointment",icon:"plus",title:"Nieuwe afspraak toevoegen",match:["nieuwe afspraak","afspraak"],navigate:()=>{window.location.href=k("add-appointment.html")}},{key:"new-werkbon",icon:"fileText",title:"Nieuwe werkbon maken",match:["werkbon","factuur"],navigate:()=>{window.location.href=k("werkbon.html?action=create")}},{key:"calendar",icon:"calendar",title:"Kalender bekijken",match:["kalender","agenda"],navigate:()=>{window.location.href=k("calendar.html")}},{key:"settings",icon:"settings",title:"Instellingen openen",match:["instellingen","settings"],navigate:()=>{window.location.href=k("settings.html")}}];return t?n.filter(r=>r.match.some(a=>t.includes(a))):[]}async function Wt(e,t){const n=jt(e),r=`${t}:${n.toLowerCase()}`;if(G.has(r))return G.get(r);if(!R())return{appointments:[],werkbonnen:[],completed:[],customers:[],emails:[],plates:[],invoices:[],includePlateSection:we(n),includeInvoiceSection:be(n),quickActions:ve(n)};const a=we(n),i=be(n),o=W(n),{indexed:l}=await Kt(t),h=[],d=async(p,S)=>{try{const L=await S();return h.push({label:p,count:Array.isArray(L)?L.length:0,ok:!0}),Array.isArray(L)?L:[]}catch(L){return h.push({label:p,count:0,ok:!1,error:L instanceof Error?L.message:String(L??"Unknown error")}),[]}},[y,b,s,m,g,c,C]=await Promise.all([d("appointments",()=>Promise.resolve(D(l.appointments,o,4,(p,S)=>p._searchToken.includes(S)))),d("werkbonnen",()=>Promise.resolve(D(l.werkbonnen,o,4,(p,S)=>p._searchToken.includes(S)))),d("completed",()=>Promise.resolve(D(l.completed,o,3,(p,S)=>p._searchToken.includes(S)))),d("customers",()=>Promise.resolve(D(l.customers,o,3,(p,S)=>p._searchToken.includes(S)))),d("emails",()=>Promise.resolve(D(l.emails,o,3,(p,S)=>p._searchToken.includes(S)))),a?d("plates",()=>Promise.resolve(D(l.plates,o,4,(p,S)=>p._plateToken.includes(S)))):Promise.resolve([]),i?d("invoices",()=>Promise.resolve(D(l.invoices,o,3,(p,S)=>p._invoiceToken.includes(S)))):Promise.resolve([])]),v={appointments:y,werkbonnen:b,completed:s,customers:m,emails:g,plates:c,invoices:C,includePlateSection:a,includeInvoiceSection:i,quickActions:ve(n)};return G.set(r,v),window.setTimeout(()=>{G.delete(r)},Rt),v}function Vt(e,t,n){const r=`data-search-item-index="${n}"`;return e.type==="appointment"?`
  ...
  `}function Jt(e,t,n,r){if(!t.length)return"";const a=t.map((i,o)=>Vt(i,n,r+o)).join("");return`
  ...
  `}function Qt(){const e=se();return e.length?`
  ...
  `,document.body.append(h);const d=h.querySelector(".mobile-search-input"),y=h.querySelector(".mobile-search-results"),b=h.querySelector(".mobile-search-back");if(!(d instanceof HTMLInputElement)||!(y instanceof HTMLElement)||!(b instanceof HTMLButtonElement))return;let s="",m=!1,g=!1,c=-1,C=[],v=0;const p=u=>{if(m=u,!m){i.hidden=!0,i.innerHTML="",c=-1,C=[];return}g||(i.hidden=!1)},S=u=>{if(g=u,h.classList.toggle("open",g),!g){document.body.style.overflow="",p(!1);return}document.body.style.overflow="hidden",d.value=a.value,s=d.value.trim(),p(!0),d.focus(),d.select(),x()},L=()=>g?d:a,H=()=>g?y:i,ie=u=>{const f=String(u??"").slice(0,re);a.value=f,d.value=f,s=f.trim()},O=u=>{u.querySelectorAll(".search-result-item").forEach(f=>{const A=Number(f.getAttribute("data-search-item-index")??-1);f.classList.toggle("is-selected",A===c)})},ce=u=>{const f=C[u];f&&(s.length>=fe&&Bt(s),p(!1),S(!1),f.open())},qe=()=>{const u=H();u.innerHTML='<div class="search-empty-small">Zoeken tijdelijk niet beschikbaar</div>',p(!0)},x=async()=>{const u=s,f=H();if(!u){f.innerHTML=Qt(),p(!0),c=-1,C=[],ze();return}if(u.length<fe){f.innerHTML='<div class="search-empty-small">Typ minimaal 2 tekens om te zoeken</div>',p(!0),c=-1,C=[];return}f.innerHTML=Zt(),p(!0);try{const A=await Wt(u,t);if(u!==s)return;const w=Yt(A);C=[...w.plates,...w.appointments,...w.werkbonnen,...w.completed,...w.customers,...w.emails,...w.invoices,...w.quickActions];let P=0;const Ve=[["Kentekens",w.plates],["Afspraken",w.appointments],["Werkbonnen",w.werkbonnen],["Voltooide afspraken",w.completed],["Klanten",w.customers],["E-mails",w.emails],["Factuurnummers",w.invoices],["Snelle acties",w.quickActions]].map(([Je,ue])=>{const Oe=Jt(Je,ue,u,P);return P+=ue.length,Oe}).join("");f.innerHTML=Ve||Ot(u),C.length?(c<0||c>=C.length)&&(c=0):c=-1,O(f)}catch{qe()}finally{}},ze=()=>{var f;const u=H();u.querySelectorAll("[data-recent-term]").forEach(A=>{A.addEventListener("click",w=>{if(w.target instanceof Element?w.target.closest("[data-recent-remove]"):null)return;const B=String(A.getAttribute("data-recent-term")??"");ie(B),x()})}),u.querySelectorAll("[data-recent-remove]").forEach(A=>{A.addEventListener("click",w=>{w.stopPropagation();const P=Number(A.getAttribute("data-recent-remove")??-1),B=se();P<0||P>=B.length||(B.splice(P,1),X(B),x())})}),(f=u.querySelector("[data-recent-clear]"))==null||f.addEventListener("click",()=>{X([]),x()})},Z=u=>{ie(u),window.clearTimeout(v),v=window.setTimeout(()=>{x()},Tt)},le=u=>{if(!m||!C.length)return;const f=C.length-1;c<0?c=u>0?0:f:(c+=u,c>f&&(c=0),c<0&&(c=f)),O(H());const A=H().querySelector(`[data-search-item-index="${c}"]`);A instanceof HTMLElement&&A.scrollIntoView({block:"nearest"})},Ke=()=>{c<0||c>=C.length||ce(c)},de=u=>{if(u.key==="ArrowDown"){u.preventDefault(),le(1);return}if(u.key==="ArrowUp"){u.preventDefault(),le(-1);return}if(u.key==="Enter"){m&&c>=0&&(u.preventDefault(),Ke());return}if(u.key==="Escape"){if(u.preventDefault(),m){p(!1);return}L().value?Z(""):g&&S(!1);return}u.key==="Tab"&&p(!1)},We=()=>{if(window.matchMedia("(max-width: 768px)").matches){S(!0);return}p(!0),a.focus(),a.select(),x()};a.addEventListener("focus",()=>{x()}),a.addEventListener("input",()=>Z(a.value)),a.addEventListener("keydown",de),d.addEventListener("input",()=>Z(d.value)),d.addEventListener("keydown",de),o.addEventListener("click",()=>{S(!0)}),b.addEventListener("click",()=>{S(!1)}),document.addEventListener("keydown",u=>{const f=String(u.key??"").toLowerCase();if((u.ctrlKey||u.metaKey)&&f==="k"){u.preventDefault(),We();return}if(f==="escape"){if(g){S(!1);return}m&&document.activeElement!==a&&document.activeElement!==d&&p(!1)}}),document.addEventListener("mousedown",u=>{const f=u.target;f instanceof Node&&(g&&h.contains(f)||n.contains(f)||p(!1))}),r.addEventListener("click",()=>{m||x()}),n.addEventListener("mouseover",u=>{const f=u.target;if(!(f instanceof Element))return;const A=f.closest(".search-result-item");if(!(A instanceof HTMLElement))return;const w=Number(A.getAttribute("data-search-item-index")??-1);w<0||w===c||(c=w,O(H()))}),n.addEventListener("click",u=>{const f=u.target;if(!(f instanceof Element))return;const A=f.closest(".search-result-item");if(!(A instanceof HTMLElement))return;const w=Number(A.getAttribute("data-search-item-index")??-1);w<0||ce(w)}),window.matchMedia("(max-width: 768px)").matches&&a.setAttribute("tabindex","-1")}const Se="garage-dashboard.prefetched-documents",en=["/dashboard.html","/calendar.html","/bookings.html","/completed.html","/werkbon.html","/werkbon-detail.html","/add-appointment.html","/emails.html","/analytics.html","/settings.html"];function tn(){try{if(window.sessionStorage.getItem(Se)==="true")return;en.forEach(e=>{if(document.head.querySelector(`link[rel="prefetch"][href="${e}"]`))return;const t=document.createElement("link");t.rel="prefetch",t.as="document",t.href=e,document.head.append(t)}),window.sessionStorage.setItem(Se,"true")}catch{}}function yn({activePage:e,title:t,headerNote:n="",userEmail:r,unreadEmailCount:a=0,onLogout:i,garage:o,isAdmin:l=!1}){tn();const h=document.createElement("div");h.className="app-shell page-animate";const{header:d,titleRow:y}=lt({title:t,headerNote:n,garage:o,activePage:e}),b=ft(e,{garage:o,isAdmin:l,userEmail:r,unreadEmailCount:a,onLogout:i}),s=document.createElement("div");s.className="app-workspace";const m=document.createElement("main");m.className="content";const g=document.createElement("div");g.className="main-content",g.append(d,s),s.append(y,m),h.append(b,g);const c=document.createElement("div");c.className="sidebar-overlay",h.append(c);const C=()=>{b.classList.add("open"),c.classList.add("open"),document.body.style.overflow="hidden"},v=()=>{b.classList.remove("open"),c.classList.remove("open"),document.body.style.overflow=""},p=d.querySelector(".topbar-hamburger");return p==null||p.addEventListener("click",C),c.addEventListener("click",v),Xt({header:d,garageId:(o==null?void 0:o.id)??""}),b.dataset.collapsed==="true"&&h.classList.add("is-sidebar-collapsed"),{shell:h,contentArea:m,setUnreadEmailCount:L=>{Ae(b,L)}}}function nn(e){return{id:e.id,name:e.name??"Garage",domain:e.domain??"",analyticsPropertyId:e.analytics_property_id??null,logoUrl:e.logo_url??"",userId:e.user_id??"",paymentLink:e.payment_link??null,mollieMethod:String(e.mollie_method??"none"),paymentDays:typeof e.payment_days=="number"?e.payment_days:parseInt(String(e.payment_days??"14"),10)||14,garageName:String(e.garage_name||e.name||"Garage")}}function rn(e){var a,i;const t="owner@gmail.com".split(",").map(o=>o.trim().toLowerCase()).filter(Boolean),n=String((e==null?void 0:e.email)??"").toLowerCase();return(((a=e==null?void 0:e.app_metadata)==null?void 0:a.role)??((i=e==null?void 0:e.user_metadata)==null?void 0:i.role)??"")==="admin"||t.includes(n)}async function an(e){const t=rn(e),n=(await rt({userId:e.id,includeAll:t})).map(nn);return{garages:n,activeGarage:n[0]??null,isAdmin:t}}const oe="garage-dashboard.auth-context",sn=5*60*1e3;function on(){try{const e=window.sessionStorage.getItem(oe);if(!e)return null;const t=JSON.parse(e);if(!t||typeof t!="object")return null;const n=Number(t.expiresAt??0);return!Number.isFinite(n)||Date.now()>n?null:t}catch{return null}}function cn(e,t){try{const n={userId:e.id,email:String(e.email??""),isAdmin:t.isAdmin,garages:t.garages??[],activeGarage:t.activeGarage??null,expiresAt:Date.now()+sn};window.sessionStorage.setItem(oe,JSON.stringify(n))}catch{}}function ln(){try{window.sessionStorage.removeItem(oe)}catch{}}async function _n(){if(!R())return window.location.href=k("index.html"),null;const e=await at();if(!e)return window.location.href=k("index.html"),null;const t=on();if(t&&t.userId===e.user.id&&String(e.user.email??"")===t.email)return{user:e.user,garages:Array.isArray(t.garages)?t.garages:[],activeGarage:t.activeGarage??null,isAdmin:!!t.isAdmin,isDemo:!1};const n=await an(e.user);return cn(e.user,n),{user:e.user,...n,isDemo:!1}}async function Cn(){try{await st()}finally{ln(),window.location.href=k("index.html")}}function An(){const e=document.documentElement;e.style.removeProperty("--brand-primary"),e.style.removeProperty("--brand-secondary"),e.style.removeProperty("--brand-primary-rgb"),e.style.removeProperty("--brand-secondary-rgb")}export{An as a,Lt as b,yn as c,pn as d,_n as e,hn as f,$t as g,bn as h,wn as i,fn as j,vn as k,Cn as l,gn as m,un as n,Sn as o,mn as p,xt as q,kn as s};
