import{d as H,c as D}from"./theme-B0f129yT.js";/* empty css                      */import{e as N,a as B,c as U,l as V,p as O,n as z,o as P,d as K,g as Y,s as G,q as j}from"./branding-D4zs9BDF.js";import{n as y,f as R}from"./rdwService-CFrMDQAa.js";import{s as W}from"./confirmDialog-DSEC2-zx.js";import{h as _,n as F,f as Z,a as J,s as Q,b as X}from"./scheduleTimePicker-zgpyiEd6.js";const C={apk:"APK",banden:"Banden",onderhoud:"Onderhoud",airco:"Airco",occasions:"Occasions",brakes:"Brakes",other:"Overige"},ee=new Map([["apk","apk"],["banden","banden"],["tire","banden"],["tires","banden"],["airco","airco"],["ac","airco"],["occasion","occasions"],["occasions","occasions"],["onderhoud","onderhoud"],["maintenance","onderhoud"],["service","onderhoud"],["brakes","brakes"],["brake","brakes"],["remmen","brakes"]]);function te(){const e=new Date,i=e.getMinutes()<30?30:60;return e.setMinutes(i,0,0),i===60&&e.setHours(e.getHours()+1,0,0,0),e}function l(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ae(e=""){return{title:y(e)||"Unknown vehicle",buildYear:""}}function ne(e){return String(e??"").toUpperCase().replace(/[^A-Z0-9]/g,"").replace(/(.{2})(?=.)/g,"$1-")}function A(e){const t=new Date(e);return Number.isNaN(t.getTime())?null:t}function ie(e){const t=A(e);return t?t.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit",hour12:!1}):"--:--"}function se(e){const t=A(e);if(!t)return"";const i=t.getFullYear(),d=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return`${i}-${d}-${n}`}function re(e){const t=A(e);if(!t)return"09:00";const i=String(t.getHours()).padStart(2,"0"),d=String(t.getMinutes()).padStart(2,"0");return`${i}:${d}`}function oe(e,t){const i=String(e??"").trim(),d=String(t??"").trim();if(!i||!d)return"";const n=`${i}T${d}:00`;return A(n)?n:""}function ce(e){return e instanceof Element&&!!e.closest("button, input, select, textarea, a, label")}function le(e){const t=String((e==null?void 0:e.appointmentAt)??"").trim(),i=String((e==null?void 0:e.receivedAt)??"").trim();return t&&i&&t!==i?t:te().toISOString()}function de(e){const t=String(e??"").trim();if(!t)return["other"];const i=t.split(t.includes(",")?/,/g:/\+|\/|&| and /gi).map(d=>d.trim()).filter(Boolean);return i.length?i:[t]}function ue(e){return ee.get(String(e??"").trim().toLowerCase())??"other"}function pe(e){return de(e).map(t=>{const i=ue(t),d=C[i]??C.other;return`<span class="service-chip service-chip-${i}">${l(d)}</span>`}).join("")}function me(e,t,i,d){return e.length?e.map((n,$)=>{const f=String(n.id??""),r=t===f,s=i===f,c=le(n),L=l(n.licensePlate&&n.licensePlate!=="UNKNOWN"?ne(n.licensePlate):"UNKNOWN"),x=l(String(n.senderName??"Website visitor")),q=n.licensePlate?y(n.licensePlate):"",g=d.get(q)||ae(n.licensePlate),E=g.buildYear?`${g.title} (${g.buildYear})`:g.title,o=l(ie(n.appointmentAt??n.receivedAt)),h=F(se(c)),b=l(h),a=l(Z(h)),u=J(re(c)),T=l(u),p=l(String(n.phone??"No phone number")),m=l(String(n.message??"No message content."));return`
        <article class="request-card ${r?"is-expanded":""}" data-email-card-id="${l(f)}">
          <div class="request-card-head">
            ...
            <div class="request-meta">
              ...
              <button
                ...
                aria-label="${r?"Collapse email details":"Expand email details"}"
              >
          ...
          ${r?`
            ...
            <div class="request-expanded">
              ...
              <div class="request-actions">
                ...
                <button class="icon-button" type="button" data-email-action="edit" data-email-id="${l(f)}" aria-label="Edit email schedule" style="gap: 8px;">✎ <span>Schedule</span></button>
