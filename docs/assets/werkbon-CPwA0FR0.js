import"./theme-8bHWXU28.js";/* empty css                         */import{e as t}from"./auth-BjeLGIG2.js";import"./paths-D6ujGOT0.js";const o=[{key:"artikelen",label:"Artikelen",description:"Beheer artikelcodes, prijzen en BTW-waarden.",href:"./werkbon-artikelen.html",icon:"boxes"},{key:"facturen",label:"Facturen",description:"Open, converteer en werk facturen bij.",href:"./werkbon-facturen.html",icon:"invoice"},{key:"omzet",label:"Omzet- en BTW overzicht",description:"Bekijk omzet, BTW en periode-overzichten.",href:"./werkbon-omzet-btw.html",icon:"chart"},{key:"instellingen",label:"Instellingen",description:"Configureer factuur- en bedrijfsinstellingen.",href:"./werkbon-instellingen.html",icon:"settings"}];function i(e){return e==="invoice"?`
  ...
  `}async function a(e){if(!e)return;const r=await t();if(r){if(!r.isAdmin&&!r.activeGarage){e.innerHTML=`
