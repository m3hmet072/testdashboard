import{p as y,d as E,g as tt,s as nt,h as rt,u as _e,i as R,m as at,j as Ce,f as Ae,k as Ee,l as st,n as ot,o as it,q as ct,a as lt,r as dt}from"./theme-CzeyRWKH.js";function x(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ut(e){return e==="bookings"?`
  ...
  `}function pt(e){const t=String((e==null?void 0:e.domain)??"").trim();if(!t)return{href:"https://autoservicehouse.nl",label:"autoservicehouse.nl"};const n=/^https?:\/\//i.test(t)?t:`https://${t}`,r=t.replace(/^https?:\/\//i,"");return{href:n,label:r}}function mt(e){const n={dashboard:"dashboard",calendar:"calender",analytics:"analytics",bookings:"appointment",addappointment:"addappointment",emails:"email",completed:"succes",werkbon:"werkbon"}[e];return n?E(`sidebar-icons/${n}.png`):null}function ht({title:e,headerNote:t="",garage:n,activePage:r="dashboard"}){var c;const a=document.createElement("div");a.className="topbar-stack";const i=pt(n),o=x(e);x(t);const l=x(i.label);x(i.href);const h=x(String(((c=n==null?void 0:n.name)==null?void 0:c[0])??"G").toUpperCase()),d=n!=null&&n.logoUrl?`<img class="brand-logo" src="${x(n.logoUrl)}" alt="" />`:`<span class="brand-mark">${h}</span>`,k=x((n==null?void 0:n.name)??""),b=mt(r),s=b?`<img class="topbar-page-icon topbar-page-icon-${x(r)}" src="${b}" alt="${o} icon" />`:`<span class="topbar-page-icon topbar-page-icon-${x(r)}">${ut(r)}</span>`;a.innerHTML=`
    <header class="topbar">
      <button class="topbar-hamburger" type="button" aria-label="Open navigation menu">
        ${d}
        <span class="topbar-hamburger-label">${k}</span>
  ...
  `;const m=a.querySelector(".topbar"),g=a.querySelector(".topbar-title-row");return{header:m,titleRow:g}}const ft=[{key:"dashboard",href:y("dashboard.html"),label:"Dashboard",icon:"dashboard"},{key:"calendar",href:y("calendar.html"),label:"Calendar",icon:"calendar"},{key:"bookings",href:y("bookings.html"),label:"Appointment",icon:"appointments"},{key:"completed",href:y("completed.html"),label:"Completed",icon:"completed"},{key:"werkbon",href:y("werkbon.html"),label:"Werkbon",icon:"werkbon"},{key:"addappointment",href:y("add-appointment.html"),label:"Add Appointment",icon:"addappointment"},{key:"emails",href:y("emails.html"),label:"E-mails",icon:"emails",showUnreadBadge:!0},{key:"analytics",href:y("analytics.html"),label:"Analytics",icon:"analytics"},{key:"settings",href:y("settings.html"),label:"Instellingen",icon:"settings"}],he={dashboard:E("sidebar-icons/dashboard.png"),appointments:E("sidebar-icons/appointment.png"),calendar:E("sidebar-icons/calender.png"),completed:E("sidebar-icons/succes.png"),werkbon:E("sidebar-icons/werkbon.png"),addappointment:E("sidebar-icons/addappointment.png"),emails:E("sidebar-icons/email.png"),analytics:E("sidebar-icons/analytics.png"),default:E("sidebar-icons/default.png"),settings:E("sidebar-icons/default.png")},fe="garage-dashboard.sidebar-collapsed";function gt(e){return`<img class="sidebar-link-icon-image" src="${he[e]??he.default}" alt="" width="32" height="33" aria-hidden="true" />`}function wt(e){return e?((String(e).split("@")[0]??"A")[0]??"A").toUpperCase():"A"}function bt(e,t){if(t)return t;const n=String(e??"").trim().split("@")[0];return n?n.split(/[._-]+/g).filter(Boolean).map(r=>r[0].toUpperCase()+r.slice(1)).slice(0,2).join(" "):"Garage User"}function St(e){var t;return e!=null&&e.logoUrl?`<img class="brand-logo" src="${e.logoUrl}" alt="${e.name} logo" />`:`<span class="brand-mark">${String(((t=e==null?void 0:e.name)==null?void 0:t[0])??"A").toUpperCase()}</span>`}function Le(e,t){const n=Number(t),r=Number.isFinite(n)?Math.max(0,Math.floor(n)):0;e.querySelectorAll("[data-email-unread-count]").forEach(i=>{i.textContent=r>99?"99+":String(r),i.hidden=r===0})}function vt(e,{garage:t,isAdmin:n=!1,userEmail:r="",onLogout:a,unreadEmailCount:i=0}={}){const o=document.createElement("aside");o.className="sidebar";const l=window.localStorage.getItem(fe)==="true";l&&(o.classList.add("is-collapsed"),o.dataset.collapsed="true");const h=ft.map(v=>{const p=v.key===e?"is-active":"";return`
      <a class="sidebar-link sidebar-link-${v.key} ${p}" href="${v.href}">
        <span class="sidebar-link-icon">${gt(v.icon)}</span>
    ...
    `}).join(""),d=bt(r,n?"Admin":""),k=n?"Owner":(t==null?void 0:t.name)??"Garage Staff",b=tt()==="dark",s=l?"Expand sidebar":"Collapse sidebar";o.innerHTML=`
...
${X}`;if(!l)throw new Error("A garage is required before creating a manual appointment.");if(!d||!k||!b||!s||!o)throw new Error("Please fill in kenteken, phone number, service, bericht, and appointment date.");const g=new Date().toISOString(),c=Ct(o,g),C=await it({garageId:l,name:h,licensePlate:d,phone:k,service:b,message:m,createdAt:g});if(C){try{await _e({bookingId:C.id,garageId:l,appointmentAt:c})}catch(S){console.warn("Unable to persist booking schedule in Supabase booking_schedule.",S)}return I(C.id,{convertedFromEmail:!1,inAppointments:!0,status:"new",appointmentAt:c}),J({...C,appointment_at:c,source:"manual",status:"new"})}const v={id:At(),garage_id:l,name:h,license_plate:d,phone:k,service:b,message:m,appointment_at:c,status:"new",source:"manual",created_at:g},p=re();return p.unshift(v),Te(p.slice(0,500)),I(v.id,{convertedFromEmail:!1,inAppointments:!0,status:"new",appointmentAt:c}),J(v)}async function Tt({garageIds:e=null}={}){const t=await rt({garageIds:e}),n=Nt({garageIds:e}),r=ne(),a=[...t.map(J),...n],i=new Map;for(const o of a){const l=String(o.id??"").trim();l&&(i.has(l)||i.set(l,o))}return Array.from(i.values()).map(o=>kt(o,r)).filter(o=>o.isDeleted!==!0).sort(It)}const He="garage_dashboard_email_read_state_v1";function Be(){return typeof window<"u"&&typeof window.localStorage<"u"}function Ue(){if(!Be())return{};try{const e=window.localStorage.getItem(He);if(!e)return{};const t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function Pt(e){Be()&&window.localStorage.setItem(He,JSON.stringify(e))}function ae(e){return String(e??"").trim()}function z(e,t){var r;const n=new RegExp(`\\b${t}\\s*:\\s*([\\s\\S]*?)(?=\\b(?:name|email|message|description|source|submittedat)\\s*:|$)`,"i");return(((r=e.match(n))==null?void 0:r[1])??"").trim()}function Rt(e){const t=String(e??"").trim();return t?/\b(?:name|email|message)\s*:/i.test(t)?{name:z(t,"name"),email:z(t,"email"),message:z(t,"message")||z(t,"description")}:{name:"",email:"",message:t}:{name:"",email:"",message:""}}function ge(e){const n=new Date(e).getTime();return Number.isFinite(n)?n:0}function Dt(e){const t=String(e??"new").trim().toLowerCase();return t==="done"||t==="completed"||t==="complete"||t==="closed"?"done":t==="confirmed"||t==="confirm"?"confirmed":"new"}function je(e){return String((e==null?void 0:e.source)??"form")==="manual"||(e==null?void 0:e.hasScheduledAppointment)===!0||(e==null?void 0:e.convertedFromEmail)===!0?!1:Dt(e==null?void 0:e.status)!=="done"}function Fe(e){const t=ae(e);return t?Ue()[t]===!0:!1}function $n(e,t=!0){const n=ae(e);if(!n)return;const r=Ue();t?r[n]=!0:delete r[n],Pt(r)}function Nn(e){const t=e.filter(je);let n=0;for(const r of t)Fe(r.id)||(n+=1);return{total:t.length,unread:n}}function Ht(e,{garageNameById:t=new Map}={}){return e.filter(je).map(n=>{const r=Rt(n.message),a=ae(n.id),i=`${n.licensePlate??"Unknown"} • ${n.service??"Service request"}`,o=r.message||String(n.message??"").trim()||"No message provided.",l=String(n.name??"").trim()||r.name||String(n.licensePlate??"").trim()||"UNKNOWN",h=r.email||"";return{id:a,subject:i,preview:o,message:o,senderName:l,senderEmail:h,phone:n.phone??"",service:n.service??"",licensePlate:n.licensePlate??"",garageId:n.garageId,garageName:t.get(n.garageId)??"",receivedAt:n.createdAt,appointmentAt:n.appointmentAt??n.createdAt,read:Fe(a)}}).sort((n,r)=>ge(r.receivedAt)-ge(n.receivedAt))}const we=2,Bt=300,Ut=3e4,jt=6e4,se=80,Ke="garage-dashboard.recent-searches",Ge=5,q=new Map,W=new Map;function _(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function Ft(e){return String(e).replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function M(e,t){const n=_(e??""),r=String(t??"").trim().slice(0,se);if(!r)return n;const a=new RegExp(`(${Ft(r)})`,"ig");return n.replace(a,"<mark>$1</mark>")}function F(e){const t=String(e??"").toUpperCase().replace(/[^A-Z0-9]/g,"");return t?t.replace(/(.{2})(?=.)/g,"$1-"):""}function V(e){const t=new Date(e);return Number.isNaN(t.getTime())?"-":t.toLocaleDateString("nl-NL",{day:"2-digit",month:"short",year:"numeric"})}function be(e){const t=Number(e??0);return Number.isFinite(t)?new Intl.NumberFormat("nl-NL",{style:"currency",currency:"EUR",minimumFractionDigits:2,maximumFractionDigits:2}).format(t):"EUR 0,00"}function oe(e){const t=String(e??"").trim().toLowerCase();return["done","completed","complete","closed"].includes(t)?"completed":["confirmed","confirm"].includes(t)?"confirmed":t||"new"}function Kt(e){const t=oe(e);return t==="completed"?"Voltooid":t==="confirmed"?"Bevestigd":t==="new"?"Nieuw":t}function Se(e){const t=String(e??"").replace(/[^a-z0-9]/gi,"");return t.length>=4&&/[a-z]/i.test(t)&&/\d/.test(t)}function ve(e){return/\d/.test(String(e??""))}function $(e){return{calendar:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M6 2.75V5M14 2.75V5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><rect x="3" y="4.5" width="14" height="12.5" rx="3" stroke="currentColor" stroke-width="1.6"/><path d="M3 8.5H17" stroke="currentColor" stroke-width="1.6"/></svg>',fileText:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M6.5 2.5H11.5L15.5 6.5V15.5C15.5 16.33 14.83 17 14 17H6C5.17 17 4.5 16.33 4.5 15.5V4C4.5 3.17 5.17 2.5 6 2.5H6.5Z" stroke="currentColor" stroke-width="1.6"/><path d="M11.5 2.5V6.5H15.5" stroke="currentColor" stroke-width="1.6"/><path d="M7 10H13M7 13H11" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',check:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="7.5" stroke="currentColor" stroke-width="1.6"/><path d="M6.8 10.2L8.9 12.3L13.3 7.9" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>',user:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="6.5" r="3" stroke="currentColor" stroke-width="1.6"/><path d="M4 16.2C4.8 13.9 6.8 12.8 10 12.8C13.2 12.8 15.2 13.9 16 16.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',mail:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><rect x="3" y="4.5" width="14" height="11" rx="2.5" stroke="currentColor" stroke-width="1.6"/><path d="M4.5 6L10 10L15.5 6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',car:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M4 11.5L5.5 7.5C5.8 6.8 6.4 6.4 7.2 6.4H12.8C13.6 6.4 14.2 6.8 14.5 7.5L16 11.5" stroke="currentColor" stroke-width="1.6"/><rect x="3.2" y="10" width="13.6" height="5.5" rx="1.8" stroke="currentColor" stroke-width="1.6"/><circle cx="6.5" cy="14" r="1.1" fill="currentColor"/><circle cx="13.5" cy="14" r="1.1" fill="currentColor"/></svg>',receipt:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M6 2.8H14V16.8L12 15.5L10 16.8L8 15.5L6 16.8V2.8Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M8 6.8H12M8 9.8H12M8 12.8H11" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',plus:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="7.5" stroke="currentColor" stroke-width="1.6"/><path d="M10 6.5V13.5M6.5 10H13.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',settings:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M10 6.9A3.1 3.1 0 1 1 10 13.1A3.1 3.1 0 0 1 10 6.9Z" stroke="currentColor" stroke-width="1.6"/><path d="M16.1 10.9L15 11.4C14.9 11.8 14.7 12.2 14.5 12.5L14.9 13.7L13.7 14.9L12.5 14.5C12.2 14.7 11.8 14.9 11.4 15L10.9 16.1H9.1L8.6 15C8.2 14.9 7.8 14.7 7.5 14.5L6.3 14.9L5.1 13.7L5.5 12.5C5.3 12.2 5.1 11.8 5 11.4L3.9 10.9V9.1L5 8.6C5.1 8.2 5.3 7.8 5.5 7.5L5.1 6.3L6.3 5.1L7.5 5.5C7.8 5.3 8.2 5.1 8.6 5L9.1 3.9H10.9L11.4 5C11.8 5.1 12.2 5.3 12.5 5.5L13.7 5.1L14.9 6.3L14.5 7.5C14.7 7.8 14.9 8.2 15 8.6L16.1 9.1V10.9Z" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"/></svg>',clock:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="10" cy="10" r="7.5" stroke="currentColor" stroke-width="1.6"/><path d="M10 6.4V10L12.5 11.4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',searchX:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><circle cx="8.5" cy="8.5" r="5.8" stroke="currentColor" stroke-width="1.6"/><path d="M12.7 12.7L17 17" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M6.8 6.8L10.2 10.2M10.2 6.8L6.8 10.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',arrowLeft:'<svg viewBox="0 0 20 20" fill="none" aria-hidden="true"><path d="M11.8 4.8L6.6 10L11.8 15.2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>'}[e]??""}function ie(){try{const e=JSON.parse(window.localStorage.getItem(Ke)||"[]");return Array.isArray(e)?e.map(t=>String(t??"").trim()).filter(Boolean).slice(0,Ge):[]}catch{return[]}}function te(e){try{window.localStorage.setItem(Ke,JSON.stringify(e.slice(0,Ge)))}catch{}}function Gt(e){const t=String(e??"").trim();if(!t)return;const n=ie().filter(r=>r.toLowerCase()!==t.toLowerCase());n.unshift(t),te(n)}function Y(e){const t=oe(e);return t==="completed"?'<span class="global-search-badge global-search-badge-success">Voltooid</span>':t==="confirmed"?'<span class="global-search-badge global-search-badge-info">Bevestigd</span>':t==="new"?'<span class="global-search-badge global-search-badge-muted">Nieuw</span>':`<span class="global-search-badge global-search-badge-muted">${_(Kt(t))}</span>`}function zt(){return/Mac|iPhone|iPad|iPod/i.test(window.navigator.platform)?"⌘K":"Ctrl+K"}function ze(e,t){var a;const n=String(e??""),r=new RegExp(`\\b${t}\\s*:\\s*([\\s\\S]*?)(?=\\b(?:name|email|message)\\s*:|$)`,"i");return(((a=n.match(r))==null?void 0:a[1])??"").trim()}function O(e){return String(e??"").toLowerCase().replace(/[^a-z0-9]/g,"")}function qt(e){return String(e??"").trim().slice(0,se)}function Wt(e){const t=String((e==null?void 0:e.name)??"").trim();if(t)return t;const n=ze(e==null?void 0:e.message,"name");return n||String((e==null?void 0:e.licensePlate)??"").trim()||"UNKNOWN"}function Vt(e){return ze(e==null?void 0:e.message,"email")}function Yt(e,t,n,r){const a=e.filter(s=>oe(s==null?void 0:s.status)!=="completed"&&(s==null?void 0:s.inAppointments)!==!1).map(s=>({id:s.id,customer_name:Wt(s),customer_email:Vt(s),customer_phone:String(s.phone??""),license_plate:String(s.licensePlate??""),car_brand:String(s.service??"Service"),status:s.status,appointment_date:s.appointmentAt||s.createdAt,services:s.service})),i=t.map(s=>({id:s.id,customer_name:s.customerName||"Onbekende klant",license_plate:s.licensePlate,car_brand:s.service||"Service",appointment_date:s.appointmentAt||s.completedAt||s.createdAt,status:"completed"})),o=[...a,...i],l=new Map;a.forEach(s=>{const m=`${s.customer_name}|${s.customer_email}|${s.license_plate}`.toLowerCase();l.has(m)||l.set(m,{customer_name:s.customer_name,customer_email:s.customer_email,customer_phone:s.customer_phone,license_plate:s.license_plate,car_brand:s.car_brand})});const h=new Map;n.forEach(s=>{let m={};try{m=JSON.parse(String(s.completion_notes??"{}"))}catch{m={}}h.set(String(s.id??""),m)});const d=t.map(s=>{var c;const m=h.get(String(s.completedAppointmentId??""))??{},g=Number(((c=m==null?void 0:m.totals)==null?void 0:c.total)??0);return{id:s.completedAppointmentId,customer_name:s.customerName||String(m.customer_name??"Onbekende klant"),license_plate:s.licensePlate,car_brand:String(m.car_model??s.service??"Service"),total:g,status:String(m.status??"draft"),factuurnummer:String(m.invoice_number??"").trim(),created_at:s.createdAt}}),k=d.filter(s=>s.factuurnummer),b=r.map(s=>({id:s.id,from_name:s.senderName,from_email:s.senderEmail,subject:s.subject,created_at:s.receivedAt,read:s.read}));return{appointmentsSource:a,completedSource:i,plateSource:o,customerSource:Array.from(l.values()),werkbonSource:d,invoiceSource:k,emailsSource:b}}function Ot(e){const t=(d,k)=>d.map(b=>({...b,_searchToken:O(k.map(s=>String(b[s]??"")).join(" "))})),n=t(e.appointmentsSource,["customer_name","customer_email","customer_phone","license_plate","car_brand"]),r=t(e.completedSource,["customer_name","license_plate","car_brand"]),a=t(e.customerSource,["customer_name","customer_email","customer_phone","license_plate","car_brand"]),i=t(e.werkbonSource,["customer_name","license_plate","car_brand","factuurnummer"]),o=t(e.emailsSource,["from_name","from_email","subject"]),l=[...n,...r].map(d=>({...d,_plateToken:O(d.license_plate)})),h=e.invoiceSource.map(d=>({...d,_invoiceToken:O(d.factuurnummer)}));return{appointments:n,completed:r,customers:a,werkbonnen:i,emails:o,plates:l,invoices:h}}function H(e,t,n,r){const a=[];for(const i of e)if(r(i,t)&&(a.push(i),a.length>=n))break;return a}async function Jt(e){const t=String(e??"").trim(),n=Date.now(),r=W.get(t);if(r!=null&&r.data&&n-r.timestamp<jt)return r.data;if(r!=null&&r.inFlight)return r.inFlight;const a=Promise.all([Tt({garageIds:[t]}),xt({garageIds:[t]}),Ae({garageIds:[t]})]).then(([i,o,l])=>{const h=Ht(i),d=Yt(i,o,l,h);return{indexed:Ot(d)}});W.set(t,{timestamp:n,data:(r==null?void 0:r.data)??null,inFlight:a});try{const i=await a;return W.set(t,{timestamp:Date.now(),data:i,inFlight:null}),i}catch(i){if(r!=null&&r.data)return r.data;throw W.delete(t),i}}function ye(e){const t=String(e??"").trim().toLowerCase(),n=[{key:"new-appointment",icon:"plus",title:"Nieuwe afspraak toevoegen",match:["nieuwe afspraak","afspraak"],navigate:()=>{window.location.href=y("add-appointment.html")}},{key:"new-werkbon",icon:"fileText",title:"Nieuwe werkbon maken",match:["werkbon","factuur"],navigate:()=>{window.location.href=y("werkbon.html?action=create")}},{key:"calendar",icon:"calendar",title:"Kalender bekijken",match:["kalender","agenda"],navigate:()=>{window.location.href=y("calendar.html")}},{key:"settings",icon:"settings",title:"Instellingen openen",match:["instellingen","settings"],navigate:()=>{window.location.href=y("settings.html")}}];return t?n.filter(r=>r.match.some(a=>t.includes(a))):[]}async function Zt(e,t){const n=qt(e),r=`${t}:${n.toLowerCase()}`;if(q.has(r))return q.get(r);if(!R())return{appointments:[],werkbonnen:[],completed:[],customers:[],emails:[],plates:[],invoices:[],includePlateSection:Se(n),includeInvoiceSection:ve(n),quickActions:ye(n)};const a=Se(n),i=ve(n),o=O(n),{indexed:l}=await Jt(t),h=[],d=async(p,S)=>{try{const L=await S();return h.push({label:p,count:Array.isArray(L)?L.length:0,ok:!0}),Array.isArray(L)?L:[]}catch(L){return h.push({label:p,count:0,ok:!1,error:L instanceof Error?L.message:String(L??"Unknown error")}),[]}},[k,b,s,m,g,c,C]=await Promise.all([d("appointments",()=>Promise.resolve(H(l.appointments,o,4,(p,S)=>p._searchToken.includes(S)))),d("werkbonnen",()=>Promise.resolve(H(l.werkbonnen,o,4,(p,S)=>p._searchToken.includes(S)))),d("completed",()=>Promise.resolve(H(l.completed,o,3,(p,S)=>p._searchToken.includes(S)))),d("customers",()=>Promise.resolve(H(l.customers,o,3,(p,S)=>p._searchToken.includes(S)))),d("emails",()=>Promise.resolve(H(l.emails,o,3,(p,S)=>p._searchToken.includes(S)))),a?d("plates",()=>Promise.resolve(H(l.plates,o,4,(p,S)=>p._plateToken.includes(S)))):Promise.resolve([]),i?d("invoices",()=>Promise.resolve(H(l.invoices,o,3,(p,S)=>p._invoiceToken.includes(S)))):Promise.resolve([])]),v={appointments:k,werkbonnen:b,completed:s,customers:m,emails:g,plates:c,invoices:C,includePlateSection:a,includeInvoiceSection:i,quickActions:ye(n)};return q.set(r,v),window.setTimeout(()=>{q.delete(r)},Ut),v}function Qt(e,t,n){const r=`data-search-item-index="${n}"`;return e.type==="appointment"?`
    ...
    `:e.type==="werkbon"?`
      <button class="search-result-item" type="button" ${r}>
        <span class="search-result-icon search-result-icon-werkbonnen">${$("fileText")}</span>
        <span class="search-result-main">
          <span class="search-result-primary"><small class="search-result-muted">${M(e.factuur,t)}</small> ${M(e.customerName,t)}</span>
          <span class="search-result-secondary"><span class="plate-chip plate-chip-small">${_(F(e.plate)||"UNKNOWN")}</span> ${_(e.carBrand||"-")}</span>
        </span>
        <span class="search-result-side">
    ...
    `:e.type==="completed"?`
      <button class="search-result-item" type="button" ${r}>
        <span class="search-result-icon search-result-icon-completed">${$("check")}</span>
        <span class="search-result-main">
          <span class="search-result-primary">${M(e.customerName,t)}</span>
          <span class="search-result-secondary">${_(e.carBrand||"-")} <span class="plate-chip plate-chip-small">${_(F(e.plate)||"UNKNOWN")}</span></span>
        </span>
    ...
    `:e.type==="customer"?`
      <button class="search-result-item" type="button" ${r}>
        <span class="search-result-icon search-result-icon-customers">${$("user")}</span>
        <span class="search-result-main">
          <span class="search-result-primary">${M(e.customerName,t)}</span>
          <span class="search-result-secondary">${M(e.email,t)}</span>
        </span>
        <span class="search-result-side">
          <span class="plate-chip plate-chip-small">${_(F(e.plate)||"UNKNOWN")}</span>
          <span class="search-result-muted">${_(e.carBrand||"-")}</span>
        </span>
      </button>
    `:e.type==="email"?`
      <button class="search-result-item" type="button" ${r}>
        <span class="search-result-icon search-result-icon-emails">${$("mail")}</span>
        <span class="search-result-main">
          <span class="search-result-primary">${e.unread?'<span class="search-unread-dot"></span>':""}${M(e.sender,t)}</span>
          <span class="search-result-secondary">${M(e.subject,t)}</span>
        </span>
        <span class="search-result-side">
          <span class="search-result-right">${_(e.date)}</span>
    ...
    `:e.type==="plate"?`
      <button class="search-result-item" type="button" ${r}>
        <span class="search-result-icon search-result-icon-plates">${$("car")}</span>
        <span class="search-result-main">
          <span class="search-result-primary"><span class="plate-chip">${M(F(e.plate),t)}</span></span>
    ...
    `:e.type==="invoice"?`
      <button class="search-result-item" type="button" ${r}>
        <span class="search-result-icon search-result-icon-invoices">${$("receipt")}</span>
        <span class="search-result-main">
          <span class="search-result-primary">${M(e.factuur,t)}</span>
          <span class="search-result-secondary">${M(e.customerName,t)}</span>
        </span>
        <span class="search-result-side">
          <span class="search-result-right">${_(e.total)}</span>
          ${Y(e.status)}
    ...
    `:`
    <button class="search-result-item" type="button" ${r}>
      <span class="search-result-icon search-result-icon-actions">${$(e.icon)}</span>
      <span class="search-result-main">
        <span class="search-result-primary">${M(e.title,t)}</span>
      </span>
    </button>
  ...
  `}function en(e){return`
    <div class="search-empty-state">
      <span class="search-empty-icon">${$("searchX")}</span>
      ...
      <div class="search-recents">
        ${e.map((t,n)=>`
          <button class="search-recent-item" type="button" data-recent-index="${n}" data-recent-term="${_(t)}">
            <span class="search-recent-left">${$("clock")} ${_(t)}</span>
  ...
  `,document.body.append(h);const d=h.querySelector(".mobile-search-input"),k=h.querySelector(".mobile-search-results"),b=h.querySelector(".mobile-search-back");if(!(d instanceof HTMLInputElement)||!(k instanceof HTMLElement)||!(b instanceof HTMLButtonElement))return;let s="",m=!1,g=!1,c=-1,C=[],v=0;const p=u=>{if(m=u,!m){i.hidden=!0,i.innerHTML="",c=-1,C=[];return}g||(i.hidden=!1)},S=u=>{if(g=u,h.classList.toggle("open",g),!g){document.body.style.overflow="",p(!1);return}document.body.style.overflow="hidden",d.value=a.value,s=d.value.trim(),p(!0),d.focus(),d.select(),T()},L=()=>g?d:a,N=()=>g?k:i,U=u=>{const f=String(u??"").slice(0,se);a.value=f,d.value=f,s=f.trim()},j=u=>{u.querySelectorAll(".search-result-item").forEach(f=>{const A=Number(f.getAttribute("data-search-item-index")??-1);f.classList.toggle("is-selected",A===c)})},de=u=>{const f=C[u];f&&(s.length>=we&&Gt(s),p(!1),S(!1),f.open())},Ye=()=>{const u=N();u.innerHTML='<div class="search-empty-small">Zoeken tijdelijk niet beschikbaar</div>',p(!0)},T=async()=>{const u=s,f=N();if(!u){f.innerHTML=nn(),p(!0),c=-1,C=[],Oe();return}if(u.length<we){f.innerHTML='<div class="search-empty-small">Typ minimaal 2 tekens om te zoeken</div>',p(!0),c=-1,C=[];return}f.innerHTML=tn(),p(!0);try{const A=await Zt(u,t);if(u!==s)return;const w=rn(A);C=[...w.plates,...w.appointments,...w.werkbonnen,...w.completed,...w.customers,...w.emails,...w.invoices,...w.quickActions];let D=0;const Qe=[["Kentekens",w.plates],["Afspraken",w.appointments],["Werkbonnen",w.werkbonnen],["Voltooide afspraken",w.completed],["Klanten",w.customers],["E-mails",w.emails],["Factuurnummers",w.invoices],["Snelle acties",w.quickActions]].map(([Xe,me])=>{const et=Xt(Xe,me,u,D);return D+=me.length,et}).join("");f.innerHTML=Qe||en(u),C.length?(c<0||c>=C.length)&&(c=0):c=-1,j(f)}catch{Ye()}finally{}},Oe=()=>{var f;const u=N();u.querySelectorAll("[data-recent-term]").forEach(A=>{A.addEventListener("click",w=>{if(w.target instanceof Element?w.target.closest("[data-recent-remove]"):null)return;const B=String(A.getAttribute("data-recent-term")??"");U(B),T()})}),u.querySelectorAll("[data-recent-remove]").forEach(A=>{A.addEventListener("click",w=>{w.stopPropagation();const D=Number(A.getAttribute("data-recent-remove")??-1),B=ie();D<0||D>=B.length||(B.splice(D,1),te(B),T())})}),(f=u.querySelector("[data-recent-clear]"))==null||f.addEventListener("click",()=>{te([]),T()})},Q=u=>{U(u),window.clearTimeout(v),v=window.setTimeout(()=>{T()},Bt)},ue=u=>{if(!m||!C.length)return;const f=C.length-1;c<0?c=u>0?0:f:(c+=u,c>f&&(c=0),c<0&&(c=f)),j(N());const A=N().querySelector(`[data-search-item-index="${c}"]`);A instanceof HTMLElement&&A.scrollIntoView({block:"nearest"})},Je=()=>{c<0||c>=C.length||de(c)},pe=u=>{if(u.key==="ArrowDown"){u.preventDefault(),ue(1);return}if(u.key==="ArrowUp"){u.preventDefault(),ue(-1);return}if(u.key==="Enter"){m&&c>=0&&(u.preventDefault(),Je());return}if(u.key==="Escape"){if(u.preventDefault(),m){p(!1);return}L().value?Q(""):g&&S(!1);return}u.key==="Tab"&&p(!1)},Ze=()=>{if(window.matchMedia("(max-width: 768px)").matches){S(!0);return}p(!0),a.focus(),a.select(),T()};a.addEventListener("focus",()=>{T()}),a.addEventListener("input",()=>Q(a.value)),a.addEventListener("keydown",pe),d.addEventListener("input",()=>Q(d.value)),d.addEventListener("keydown",pe),o.addEventListener("click",()=>{S(!0)}),b.addEventListener("click",()=>{S(!1)}),document.addEventListener("keydown",u=>{const f=String(u.key??"").toLowerCase();if((u.ctrlKey||u.metaKey)&&f==="k"){u.preventDefault(),Ze();return}if(f==="escape"){if(g){S(!1);return}m&&document.activeElement!==a&&document.activeElement!==d&&p(!1)}}),document.addEventListener("mousedown",u=>{const f=u.target;f instanceof Node&&(g&&h.contains(f)||n.contains(f)||p(!1))}),r.addEventListener("click",()=>{m||T()}),n.addEventListener("mouseover",u=>{const f=u.target;if(!(f instanceof Element))return;const A=f.closest(".search-result-item");if(!(A instanceof HTMLElement))return;const w=Number(A.getAttribute("data-search-item-index")??-1);w<0||w===c||(c=w,j(N()))}),n.addEventListener("click",u=>{const f=u.target;if(!(f instanceof Element))return;const A=f.closest(".search-result-item");if(!(A instanceof HTMLElement))return;const w=Number(A.getAttribute("data-search-item-index")??-1);w<0||de(w)}),window.matchMedia("(max-width: 768px)").matches&&a.setAttribute("tabindex","-1")}const qe="garage_dashboard_app_state_v1";function We(){return typeof window<"u"&&typeof window.localStorage<"u"}function K(e){const t=e&&typeof e=="object"?e:{},n=t.pages&&typeof t.pages=="object"?t.pages:{};return{currentPage:String(t.currentPage??"").trim(),pages:n}}function ce(e={currentPage:"",pages:{}}){if(!We())return K(e);try{const t=window.localStorage.getItem(qe);if(!t)return K(e);const n=JSON.parse(t);return K(n)}catch{return K(e)}}function Ve(e){if(!We())return;const t=K(e);try{window.localStorage.setItem(qe,JSON.stringify(t))}catch{}}function sn(e,t){const n=String(e??"").trim();if(!n||!t||typeof t!="object")return;const r=ce(),a=r.pages[n]&&typeof r.pages[n]=="object"?r.pages[n]:{};Ve({...r,pages:{...r.pages,[n]:{...a,...t}}})}function on(e){const t=String(e??"").trim();if(!t)return;const n=ce();Ve({...n,currentPage:t})}function cn(e,t={}){const n=String(e??"").trim();if(!n)return t;const a=ce().pages[n];return a&&typeof a=="object"?a:t}function ln(e,t){sn(e,t)}const ke="garage-dashboard.prefetched-documents",dn=["/dashboard.html","/calendar.html","/bookings.html","/completed.html","/werkbon.html","/werkbon-detail.html","/add-appointment.html","/emails.html","/analytics.html","/settings.html"];function un(){try{if(window.sessionStorage.getItem(ke)==="true")return;dn.forEach(e=>{if(document.head.querySelector(`link[rel="prefetch"][href="${e}"]`))return;const t=document.createElement("link");t.rel="prefetch",t.as="document",t.href=e,document.head.append(t)}),window.sessionStorage.setItem(ke,"true")}catch{}}function In({activePage:e,title:t,headerNote:n="",userEmail:r,unreadEmailCount:a=0,onLogout:i,garage:o,isAdmin:l=!1}){un(),on(e);const h=document.createElement("div");h.className="app-shell page-animate";const{header:d,titleRow:k}=ht({title:t,headerNote:n,garage:o,activePage:e}),b=vt(e,{garage:o,isAdmin:l,userEmail:r,unreadEmailCount:a,onLogout:i}),s=document.createElement("div");s.className="app-workspace";const m=document.createElement("main");m.className="content";const g=document.createElement("div");g.className="main-content",g.append(d,s),s.append(k,m),h.append(b,g);const c=document.createElement("div");c.className="sidebar-overlay",h.append(c);const C=()=>{b.classList.add("open"),c.classList.add("open"),document.body.style.overflow="hidden"},v=()=>{b.classList.remove("open"),c.classList.remove("open"),document.body.style.overflow=""},p=d.querySelector(".topbar-hamburger");p==null||p.addEventListener("click",C),c.addEventListener("click",v),an({header:d,garageId:(o==null?void 0:o.id)??""}),b.dataset.collapsed==="true"&&h.classList.add("is-sidebar-collapsed");const S=j=>{Le(b,j)},L=cn(e,{}),N=Number(L.scrollY??0);Number.isFinite(N)&&N>0&&window.requestAnimationFrame(()=>{window.scrollTo({top:N,behavior:"auto"})});const U=()=>{ln(e,{scrollY:Math.max(0,Math.round(window.scrollY||0))})};return window.addEventListener("scroll",U,{passive:!0}),window.addEventListener("beforeunload",U),{shell:h,contentArea:m,setUnreadEmailCount:S}}function pn(e){return{id:e.id,name:e.name??"Garage",domain:e.domain??"",analyticsPropertyId:e.analytics_property_id??null,logoUrl:e.logo_url??"",userId:e.user_id??"",paymentLink:e.payment_link??null,mollieMethod:String(e.mollie_method??"none"),paymentDays:typeof e.payment_days=="number"?e.payment_days:parseInt(String(e.payment_days??"14"),10)||14,garageName:String(e.garage_name||e.name||"Garage")}}function mn(e){var a,i;const t="owner@gmail.com".split(",").map(o=>o.trim().toLowerCase()).filter(Boolean),n=String((e==null?void 0:e.email)??"").toLowerCase();return(((a=e==null?void 0:e.app_metadata)==null?void 0:a.role)??((i=e==null?void 0:e.user_metadata)==null?void 0:i.role)??"")==="admin"||t.includes(n)}async function hn(e){const t=mn(e),n=(await ct({userId:e.id,includeAll:t})).map(pn);return{garages:n,activeGarage:n[0]??null,isAdmin:t}}const le="garage-dashboard.auth-context",fn=5*60*1e3;function gn(){try{const e=window.sessionStorage.getItem(le);if(!e)return null;const t=JSON.parse(e);if(!t||typeof t!="object")return null;const n=Number(t.expiresAt??0);return!Number.isFinite(n)||Date.now()>n?null:t}catch{return null}}function wn(e,t){try{const n={userId:e.id,email:String(e.email??""),isAdmin:t.isAdmin,garages:t.garages??[],activeGarage:t.activeGarage??null,expiresAt:Date.now()+fn};window.sessionStorage.setItem(le,JSON.stringify(n))}catch{}}function bn(){try{window.sessionStorage.removeItem(le)}catch{}}async function xn(){if(!R())return window.location.href=y("index.html"),null;const e=await lt();if(!e)return window.location.href=y("index.html"),null;const t=gn();if(t&&t.userId===e.user.id&&String(e.user.email??"")===t.email)return{user:e.user,garages:Array.isArray(t.garages)?t.garages:[],activeGarage:t.activeGarage??null,isAdmin:!!t.isAdmin,isDemo:!1};const n=await hn(e.user);return wn(e.user,n),{user:e.user,...n,isDemo:!1}}async function Tn(){try{await dt()}finally{bn(),window.location.href=y("index.html")}}function Pn(){const e=document.documentElement;e.style.removeProperty("--brand-primary"),e.style.removeProperty("--brand-secondary"),e.style.removeProperty("--brand-primary-rgb"),e.style.removeProperty("--brand-secondary-rgb")}export{Pn as a,cn as b,In as c,xt as d,xn as e,ln as f,Tt as g,yn as h,_n as i,Ln as j,En as k,Tn as l,An as m,Cn as n,Mn as o,kn as p,vn as q,$n as r,Nn as s,Ht as t};
