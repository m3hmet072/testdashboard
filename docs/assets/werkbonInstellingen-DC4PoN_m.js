import"./theme-8bHWXU28.js";/* empty css                         */import{m,r as u}from"./werkbonSubPageFactory-CdQJN28U.js";import"./auth-BjeLGIG2.js";import"./paths-D6ujGOT0.js";function g({store:l}={}){const n=document.createElement("section");if(n.className="werkbon-section panel page-animate",!l)return n.innerHTML='<p class="muted">Instellingen kunnen niet geladen worden.</p>',n;let r="";const o=()=>{const{settings:e}=l.getState();n.innerHTML=`
    ...
    `};return o(),n.addEventListener("submit",e=>{const a=e.target;if(!(a instanceof HTMLFormElement)||a.dataset.form!=="settings")return;e.preventDefault();const t=new FormData(a);l.saveSettings({invoicePrefix:String(t.get("invoicePrefix")||"F-").trim(),invoiceStartNumber:Number(t.get("invoiceStartNumber")||1001),defaultBTW:Number(t.get("defaultBTW")||21),companyName:String(t.get("companyName")||"").trim(),address:String(t.get("address")||"").trim(),kvkNumber:String(t.get("kvkNumber")||"").trim(),btwNumber:String(t.get("btwNumber")||"").trim(),language:String(t.get("language")||"NL").trim(),hourlyRate:Number(t.get("hourlyRate")||0),paymentTermDays:Number(t.get("paymentTermDays")||14)}),r="Instellingen opgeslagen",o()}),n.addEventListener("change",e=>{var s;const a=e.target;if(!(a instanceof HTMLInputElement)||a.dataset.action!=="logo")return;const t=(s=a.files)==null?void 0:s[0];if(!t)return;const i=new FileReader;i.onload=()=>{l.saveSettings({logoDataUrl:String(i.result||"")}),r="Logo opgeslagen",o()},i.readAsDataURL(t)}),n}const p=document.querySelector("#app");m(p,{title:"Werkbon - Instellingen",note:"Werkbon instellingen",showTitleRow:!1,headerToolbarHtml:u(),createSection:g});
