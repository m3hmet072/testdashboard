import{c as Le}from"./theme-Duhjov3V.js";/* empty css                      */import{e as ke,a as Me,c as $e,l as Ee,g as He,t as n,j as ye,b as Ae,s as Pe}from"./branding-D4_zwwaR.js";import{n as Te,f as qe}from"./rdwService-CFrMDQAa.js";import{h as xe,a as Ie,f as Be,s as Ce,n as De,b as Ne}from"./scheduleTimePicker-q1IARKz3.js";const Se="Manual appointment created in dashboard.",Ve={apk:"apk",banden:"banden",onderhoud:"onderhoud",airco:"airco",occasions:"occasions",brakes:"brakes"},Re=["APK","Banden","Onderhoud","Airco","Occasions","Remmen"];function Ye(r){return String(r).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function _(r){return r.toISOString().slice(0,10)}function U(){const r=new Date,C=r.getMinutes()<30?30:60;return r.setMinutes(C,0,0),C===60&&r.setHours(r.getHours()+1,0,0,0),r}function A(r=""){const l=Te(r);return{title:l?`${l}`:"Voertuig gegevens",buildYear:"",apkExpiryDate:"",color:"",fuel:""}}async function je(r){var me,ve,fe,ge;if(!r)return;const l=await ke();if(!l)return;if(!l.isAdmin&&!l.activeGarage){r.innerHTML=`
