import{e as De,c as Oe}from"./theme-BVsy-V8_.js";/* empty css                      */import{e as Ke,a as Ve,c as Fe,l as We,z as Re}from"./branding-CkZidQ_L.js";const ze="https://mkgfckxiusdcnqhethdy.supabase.co",$e="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1rZ2Zja3hpdXNkY25xaGV0aGR5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzMwMDQ4MzIsImV4cCI6MjA4ODU4MDgzMn0.LD7oUSC-S-Kwdjkfgivz1_-tA3QzNS6-W8sETLha2lc",T=De(ze,$e);function Ie(Z){return String(Z).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function pe(Z,f){return`
