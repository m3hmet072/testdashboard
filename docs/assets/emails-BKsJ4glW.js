import{d as z,c as W}from"./theme-DFmgD8P9.js";/* empty css                      */import{e as Y,a as F,c as _,l as Z,p as J,w as Q,x as K,o as X,b as ee,s as te,y as ae,t as I,g as y,f as C}from"./branding-B2eQ7lFX.js";import{n as H,f as ne}from"./rdwService-CFrMDQAa.js";import{s as se}from"./confirmDialog-DSEC2-zx.js";import{h as ie,n as q,a as re,f as oe,s as ce,b as O}from"./scheduleTimePicker-Cz5F-D9k.js";const le=new Map([["apk","apk"],["banden","banden"],["tire","banden"],["tires","banden"],["airco","airco"],["ac","airco"],["occasion","occasions"],["occasions","occasions"],["onderhoud","onderhoud"],["maintenance","onderhoud"],["service","onderhoud"],["brakes","brakes"],["brake","brakes"],["remmen","brakes"]]);function de(){const e=new Date,a=e.getMinutes()<30?30:60;return e.setMinutes(a,0,0),a===60&&e.setHours(e.getHours()+1,0,0,0),e}function u(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ue(e=""){return{title:H(e)||"Unknown vehicle",buildYear:""}}function R(e){return String(e??"").toUpperCase().replace(/[^A-Z0-9]/g,"").replace(/(.{2})(?=.)/g,"$1-")}function A(e){const t=new Date(e);return Number.isNaN(t.getTime())?null:t}function pe(e){const t=A(e);return t?t.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit",hour12:!1}):"--:--"}function me(e){const t=A(e);if(!t)return"";const a=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return`${a}-${o}-${n}`}function ge(e){const t=A(e);if(!t)return"09:00";const a=String(t.getHours()).padStart(2,"0"),o=String(t.getMinutes()).padStart(2,"0");return`${a}:${o}`}function he(e,t){const a=String(e??"").trim(),o=String(t??"").trim();if(!a||!o)return"";const n=`${a}T${o}:00`;return A(n)?n:""}function fe(e){return e instanceof Element&&!!e.closest("button, input, select, textarea, a, label")}function be(e){const t=String((e==null?void 0:e.appointmentAt)??"").trim(),a=String((e==null?void 0:e.receivedAt)??"").trim();return t&&a&&t!==a?t:de().toISOString()}const V="Manual appointment created in dashboard.";function j(e){const a=String(e??"").match(/\buntil\s*:\s*([0-2]?\d:[0-5]\d)\b/i);return((a==null?void 0:a[1])??"").trim()}function ve(e){const t=q(e),[a,o]=t.split(":"),n=Number(a),S=Number(o);if(!Number.isFinite(n)||!Number.isFinite(S))return"01:00";const l=new Date(2e3,0,1,n,S,0,0);return l.setHours(l.getHours()+1),`${String(l.getHours()).padStart(2,"0")}:${String(l.getMinutes()).padStart(2,"0")}`}function Se(e,t){const a=q(t);return`${String(e??"").trim().replace(/\n?\s*until\s*:\s*[0-2]?\d:[0-5]\d\s*/gi,`
`).replace(/\n{2,}/g,`
`).trim()}
...
`).replace(/\n{2,}/g,`
`).trim();return a||(t.toLowerCase().includes(V.toLowerCase())?V:"No message content.")}function we(e){const t=pe((e==null?void 0:e.appointmentAt)??(e==null?void 0:e.receivedAt)),a=j(e==null?void 0:e.message);return a?`${t} - ${a}`:t}function ke(e){const t=String(e??"").trim();if(!t)return["other"];const a=t.split(t.includes(",")?/,/g:/\+|\/|&| and /gi).map(o=>o.trim()).filter(Boolean);return a.length?a:[t]}function Le(e){return le.get(String(e??"").trim().toLowerCase())??"other"}function Te(e){const t=String(e??"").trim(),a=y();if(!t)return{key:"other",label:C("other",a)};const o=t.toLowerCase(),n=Le(t);if(n==="other"){if(["other","overig","overige"].includes(o))return{key:n,label:C("other",a)};const S=t.replace(/^\s*(other|overig|overige)\s*[:\-]\s*/i,"").trim();return{key:n,label:S||t}}return{key:n,label:C(n,a)}}function qe(e){return ke(e).map(t=>{const{key:a,label:o}=Te(t);return`<span class="service-chip service-chip-${a}">${u(o)}</span>`}).join("")}function Ee(e,t,a,o){return e.length?e.map((n,S)=>{const l=String(n.id??""),i=t===l,r=a===l,p=be(n),L=String(n.licensePlate??"").toUpperCase()==="UNKNOWN",M=u(n.color??"#2563EB"),T=u(n.licensePlate&&n.licensePlate!=="UNKNOWN"?R(n.licensePlate):"UNKNOWN"),v=n.licensePlate?R(n.licensePlate):"UNKNOWN",E=u(String(n.senderName??v)),c=n.licensePlate?H(n.licensePlate):"",g=o.get(c)||ue(n.licensePlate),k=g.buildYear?`${g.title} (${g.buildYear})`:g.title,s=u(we(n)),m=re(me(p)),P=u(m),h=u(oe(m)),d=q(ge(p)),N=u(d),f=q(j(n.message)||ve(d)),w=u(f),b=u(String(n.phone??"No phone number")),x=u($e(n.message));return`
        <article class="request-card ${i?"is-expanded":""}" data-email-card-id="${u(l)}">
          <div class="request-card-head">
            <div class="request-main">
              ${L?`<span class="fast-appt-dot" style="background: ${M}" aria-hidden="true"></span>`:`<span class="plate-chip">${T}</span>`}
